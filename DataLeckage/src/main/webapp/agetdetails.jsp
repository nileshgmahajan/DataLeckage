...
function open1(){
    window.location = "http://localhost:8080/DataLeckage/changepass.jsp"
}
function open2(){
    window.location = "http://localhost:8080/DataLeckage/editagent.jsp"
}
...
<%
 ...
 Connection con1=null;
	...
	try
	{
		...
		//con=databasecon.getconnection();
		con =  DriverManager.getConnection("jdbc:mysql://localhost:3306/dataleakage","root","");
